...
## [13.1.18] Ã¢â‚¬â€ 2026-06-12 Ã¢â‚¬â€ PWA Install Banner + Print Toolbar
...
## [13.1.17] ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â 2026-06-12 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Feature: Calendar Print Support
...
## [13.1.6] ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â 2026-06-12 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Fix PWA 404
...
- Correcciones de seguridad: CSP, noopener, sanitizaciÃƒÆ’Ã‚Â³n innerHTML
- Correcciones de accesibilidad: focus trap, ARIA, contraste
- ActualizaciÃƒÆ’Ã‚Â³n de documentaciÃƒÆ’Ã‚Â³n: versiones, AGENTS.md, ADR

## [13.0.0] ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â 2026-06-05 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â RefactorizaciÃƒÆ’Ã‚Â³n de Arquitectura Base

### AÃƒÆ’Ã‚Â±adido

- MigraciÃƒÆ’Ã‚Â³n completa a **ES Modules** con `import`/`export`.
- Sistema multi-agente para orquestaciÃƒÆ’Ã‚Â³n de tareas (AGENTS.md, opencode.json).
- Suite de tests con **Vitest** (4 archivos, 41 tests).
- Cobertura de cÃƒÆ’Ã‚Â³digo >70% (100% en data.js, ics.js, sun.js; 98.2% en calendar.js).
- ConfiguraciÃƒÆ’Ã‚Â³n de **ESLint** (flat config) con reglas ES2020+.
...
- **CI/CD** con GitHub Actions (test + build + deploy automÃƒÆ’Ã‚Â¡tico a GitHub Pages).
...
- **JSDoc** en todas las funciones pÃƒÆ’Ã‚Âºblicas de calendar.js.

### Corregido

- CÃƒÆ’Ã‚Â¡lculo del turno sacerdotal: `Math.floor((totalDays + 3) / 7)` alinea semanas al lÃƒÆ’Ã‚Â­mite dominical.
- Mutaciones de Date en app.js reemplazadas por aritmÃƒÆ’Ã‚Â©tica de new Date inmutable.
- Rutas en sw.js cambiadas a relativas (`./`) para compatibilidad localhost/producciÃƒÆ’Ã‚Â³n.
- AÃƒÆ’Ã‚Â±o dinÃƒÆ’Ã‚Â¡mico en ics.js: `findLiturgicalStart(year)` escanea desde el 1 de marzo (antes 15 de marzo), ventana de 50 dÃƒÆ’Ã‚Â­as (antes 30).
...
- AnimaciÃƒÆ’Ã‚Â³n `pulse` del botÃƒÆ’Ã‚Â³n de instalaciÃƒÆ’Ã‚Â³n limitada a 3 iteraciones.
- Despliegue movido de `deploy.yml` raÃƒÆ’Ã‚Â­z a `.github/workflows/deploy.yml`.
...
- `--faint` ahora es color sÃƒÆ’Ã‚Â³lido WCAG AA en lugar de opacidad.
- BotÃƒÆ’Ã‚Â³n de instalaciÃƒÆ’Ã‚Â³n PWA con animaciÃƒÆ’Ã‚Â³n no intrusiva.
- DocumentaciÃƒÆ’Ã‚Â³n profesional (README, CONTRIBUTING, LICENSE, CHANGELOG).

---

## [0.0.0] ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Proyecto Inicial

- Primera versiÃƒÆ’Ã‚Â³n funcional del calendario de 364 dÃƒÆ’Ã‚Â­as.
- Interfaz bÃƒÆ’Ã‚Â¡sica con navegaciÃƒÆ’Ã‚Â³n y datos litÃƒÆ’Ã‚Âºrgicos.
