...
[![Version](https://img.shields.io/badge/version-13.1.71-gold)](package.json)
...
### 13.1.71 (2026-08-11)
Release tagging: workflow que crea tag vX.Y.Z y Release auto al push a main (5.13).

### 13.1.70 (2026-08-11)
E2E instalacion PWA: beforeinstallprompt muestra banner e instalar lo oculta (5.11).

### 13.1.69 (2026-08-11)
E2E permiso notificaciones: aceptar activa recordatorios, denegar muestra fallback (5.10).
