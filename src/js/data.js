...
export const QumranData = {
    ...
    DIAS: [
        'Yom Rishon (Día Uno)',
        'Yom Sheni (Día Dos)',
        'Yom Shlishi (Día Tres)',
        'Yom Revii (Día Cuatro)',
        'Yom Hamishi (Día Cinco)',
        'Yom Shishi (Día Seis)',
        'Shabat (Reposo)',
    ],
    ...
    HALAKHA: [
        ...
        },
        {
            ...
            h: 'Chesed (חֶסֶד)',
            c: 'Torá y Profetas',
            f: 'Amor leal. Haz por otros lo que quisieras para ti.',
            q: 'Todas las cosas que queráis que los hombres hagan con vosotros, así también haced.',
            a: 'Haz un favor proactivo antes de que te lo pidan.',
            r: 'Mt 7:12',
        },
        {
            t: 'Cimiento',
            h: 'Emunah (אֱמוּנָה)',
            c: 'Los dos constructores',
            f: 'Fidelidad. No es solo creer, es construir vida sobre la obediencia.',
            q: 'El que oye estas palabras y las hace, le compararé a un hombre prudente.',
            a: 'Obedece una instrucción difícil hoy sin quejarte.',
            r: 'Mt 7:24',
        },
        {
            t: 'Misericordia',
            h: 'Rachamim (רַחֲמִים)',
            c: 'Llamado de Mateo',
            f: 'Amor entrañable, como el de una madre (Rechem).',
            q: 'Misericordia quiero, y no sacrificio.',
            a: 'Muestra compasión con alguien que cometa un error hoy.',
            r: 'Mt 9:13',
        },
        {
            t: 'Humildad',
            h: 'Anavah (עֲנָוָה)',
            c: 'Contra los Fariseos',
            f: 'Conocer tu lugar ante Dios. No es debilidad, es control del ego.',
            q: 'El que se humilla será enaltecido.',
            a: 'Cede el mejor lugar o el paso a otra persona hoy.',
            r: 'Mt 23:12',
        },
        {
            t: 'Perdón',
            h: 'Selichah (סְלִיחָה)',
            c: 'Parábola del siervo',
            f: 'Soltar la deuda. El perdón libera al acreedor más que al deudor.',
            q: 'No te digo hasta siete, sino aun hasta setenta veces siete.',
            a: 'Perdona una deuda emocional pendiente hoy.',
            r: 'Mt 18:22',
        },
        {
            t: 'Vigilancia',
            h: 'Shokéd (שֹׁקֵד)',
            c: 'Discurso del Monte',
            f: 'Estar alerta, como el almendro que despierta primero.',
            q: 'Velad, pues, porque no sabéis a qué hora ha de venir vuestro Señor.',
            a: 'Vive esta hora como si Yeshua llegara hoy.',
            r: 'Mt 24:42',
        },
        {
            t: 'Servicio',
            h: 'Avodá (עֲבוֹדָה)',
            c: 'Petición de Santiago y Juan',
            f: 'Servicio y Adoración son la misma palabra. Servir es adorar.',
            q: 'El Hijo del Hombre no vino para ser servido, sino para servir.',
            a: 'Sirve en la tarea más humilde de tu casa hoy.',
            r: 'Mt 20:28',
        },
        {
            t: 'Luz',
            h: 'Or (אוֹר)',
            c: 'Sal y Luz',
            f: 'La luz no hace ruido, solo alumbra. Tus obras hablan más que tu voz.',
            q: 'Así alumbre vuestra luz delante de los hombres.',
            a: 'Haz una buena obra pública que glorifique al Padre.',
            r: 'Mt 5:16',
        },
        {
            t: 'Ira',
            h: "Ka'as (כַּעַס)",
            c: 'Homicidio del corazón',
            f: 'La ira es idolatría del yo. Quien se enoja, pierde la sabiduría.',
            q: 'Cualquiera que se enoje contra su hermano, será culpable de juicio.',
            a: 'Controla tu temperamento hoy; no respondas mal.',
            r: 'Mt 5:22',
        },
        {
            t: 'Reconciliación',
            h: 'Shalom (שָׁלוֹם)',
            c: 'Ofrenda en el altar',
            f: 'Restaurar la plenitud. El altar espera hasta que la paz vuelva.',
            q: 'Deja allí tu ofrenda... y anda, reconcíliate primero.',
            a: 'Llama a alguien con quien estés enemistado.',
            r: 'Mt 5:24',
        },
        {
            t: 'Segunda Milla',
            ...
            f: 'Generosidad del espíritu. Hacer más de lo requerido rompe la opresión.',
            q: 'A cualquiera que te obligue a llevar carga por una milla, ve con él dos.',
            a: 'Haz más de lo que se te exige en tu trabajo hoy.',
            r: 'Mt 5:41',
        },
        {
            t: 'Secreto',
            h: 'Seter (סֵתֶר)',
            c: 'Limosna y Oración',
            f: 'El lugar oculto donde habita el Altísimo. La intimidad requiere privacidad.',
            q: 'Tu Padre que ve en lo secreto te recompensará en público.',
            a: 'Ora a solas 10 minutos sin decirle a nadie.',
            r: 'Mt 6:6',
        },
        {
            t: 'El Pan',
            h: 'Lechem (לֶחֶם)',
            c: 'Padre Nuestro',
            f: 'Sustento diario. Reconocer que todo viene de Su mano, día a día.',
            q: 'El pan nuestro de cada día, dánoslo hoy.',
            a: 'Agradece por cada comida y comparte tu pan.',
            r: 'Mt 6:11',
        },
        {
            t: 'Juicio',
            h: 'Mishpat (מִשְׁפָּט)',
            c: 'La viga y la paja',
            f: 'Justicia. Al juzgar al otro, estableces la medida para ti mismo.',
            q: 'No juzguéis, para que no seáis juzgados.',
            a: 'Si ves un error en otro, calla y ora por él.',
            r: 'Mt 7:1',
        },
        {
            t: 'La Puerta',
            h: 'Delet (דֶּלֶת)',
            c: 'Dos caminos',
            f: 'La entrada al Reino requiere despojarse de cargas innecesarias.',
            q: 'Entrad por la puerta estrecha.',
            a: 'Elige el camino difícil pero correcto hoy.',
            r: 'Mt 7:13',
        },
        {
            t: 'Frutos',
            h: 'Peri (פְּרִי)',
            c: 'Falsos profetas',
            f: 'El resultado visible de la esencia invisible. El carácter es la prueba.',
            q: 'Por sus frutos los conoceréis.',
            a: 'Que tus acciones de hoy muestren paciencia y bondad.',
            r: 'Mt 7:20',
        },
        {
            t: 'Confesión',
            h: 'Todah (תּוֹדָה)',
            c: 'Envío de los doce',
            f: 'Confesión y agradecimiento. Reconocer públicamente la verdad.',
            q: 'A cualquiera que me confiese delante de los hombres, yo también le confesaré.',
            a: 'Habla de Yeshua a alguien hoy.',
            r: 'Mt 10:32',
        },
        {
            t: 'Descanso',
            h: 'Menuchah (מְנוּחָה)',
            c: 'Yugo fácil',
            f: 'Reposo del alma. No es inactividad, es paz en medio de la labor.',
            q: 'Venid a mí todos los que estáis trabajados... y yo os haré descansar.',
            a: 'Dedica 15 min a reposar en Su presencia.',
            r: 'Mt 11:28',
        },
        {
            t: 'Palabras',
            h: 'Lashon (לָשׁוֹן)',
            c: 'El árbol y el fruto',
            f: 'La lengua revela el corazón. La vida y la muerte están en su poder.',
            q: 'De toda palabra ociosa que hablen los hombres, de ella darán cuenta.',
            a: 'Evita el chisme y la queja hoy.',
            r: 'Mt 12:36',
        },
        {
            t: 'Sembrador',
            ...
            f: 'La semilla es la Palabra. El corazón es la tierra que decide el fruto.',
            q: 'El que fue sembrado en buena tierra, éste es el que oye y entiende.',
            a: 'Medita en la Escritura profundamente hoy.',
            r: 'Mt 13:23',
        },
        {
            t: 'Limpieza',
            h: 'Taharah (טָהֳרָה)',
            c: 'Tradiciones humanas',
            f: 'Pureza ritual vs moral. Lo interno define lo externo.',
            q: 'Lo que sale de la boca, esto contamina al hombre.',
            a: 'Purifica tu vocabulario hoy.',
            r: 'Mt 15:11',
        },
        {
            t: 'Fe',
            h: 'Emunah (אֱמוּנָה)',
            c: 'El joven lunático',
            f: 'Confianza total en el poder de Dios, aunque sea pequeña como semilla.',
            q: 'Si tuvierais fe como un grano de mostaza...',
            a: 'Ora por un imposible creyendo.',
            r: 'Mt 17:20',
        },
        {
            t: 'Niños',
            h: 'Yeladim (יְלָדִים)',
            c: 'Grandeza en el Reino',
            f: 'Inocencia, dependencia y falta de ambición de poder.',
            q: 'Si no os volvéis y os hacéis como niños, no entraréis en el reino.',
            a: 'Mantén la inocencia y la capacidad de asombro hoy.',
            r: 'Mt 18:3',
        },
        {
            t: 'Acuerdo',
            h: 'Echad (אֶחָד)',
            c: 'Disciplina eclesial',
            f: 'Unidad. Cuando dos corazones laten como uno, Dios está allí.',
            q: 'Si dos de vosotros se pusieren de acuerdo... les será hecho.',
            a: 'Ora con tu pareja o amigo por una meta común.',
            r: 'Mt 18:19',
        },
        {
            t: 'Honra',
            h: 'Kavod (כָּבוֹד)',
            c: 'Joven rico',
            f: 'Dar peso, importancia y respeto a quienes nos dieron la vida.',
            q: 'Honra a tu padre y a tu madre.',
            a: 'Llama o visita a tus padres para bendecirlos.',
            r: 'Mt 19:19',
        },
        {
            t: 'Grandeza',
            h: 'Gedulah (גְּדֻלָּה)',
            c: 'Petición de Zebedeos',
            f: 'En el Reino, subir es bajar. El esclavo de todos es el rey de todos.',
            q: 'El que quiera hacerse grande entre vosotros será vuestro servidor.',
            a: 'Busca cómo servir, no cómo ser servido.',
            r: 'Mt 20:26',
        },
        {
            t: 'Fe Activa',
            h: 'Bitachon (בִּטָּחוֹן)',
            c: 'La higuera estéril',
            f: 'Certeza de que la oración ya ha sido respondida en el cielo.',
            q: 'Todo lo que pidiereis en oración, creyendo, lo recibiréis.',
            a: 'Pide con certeza, sin dudar.',
            r: 'Mt 21:22',
        },
        {
            t: 'Amor Total',
            h: 'Shema (שְׁמַע)',
            c: 'El Gran Mandamiento',
            f: 'Escucha y obedece. Amar con todo el ser, sin reservas.',
            q: 'Amarás al Señor tu Dios con todo tu corazón.',
            a: 'Dile a Dios que lo amas con voz audible.',
            r: 'Mt 22:37',
        },
        {
            t: 'Prójimo',
            ...
            f: 'El otro no es ajeno, es tu espejo. Tu compañero de pacto.',
            q: 'Amarás al Señor tu Dios como a ti mismo.',
            a: 'Trata al extraño con la dignidad de un rey.',
            r: 'Mt 22:39',
        },
        {
            t: 'Justicia',
            h: 'Tzedaká (צְדָקָה)',
            c: 'Ay de los Escribas',
            f: 'Justicia social y rectitud. Más importante que el diezmo de la menta.',
            q: '¡Ay de vosotros... que dejáis lo más importante: la justicia, la misericordia y la fe!',
            a: 'Sé justo en tus tratos comerciales hoy.',
            r: 'Mt 23:23',
        },
        {
            t: 'Retorno',
            h: 'Shuv (שׁוּב)',
            c: 'Señales del fin',
            f: 'El regreso. La esperanza de la redención final es visible.',
            q: 'Como el relámpago que sale del oriente... así será la venida del Hijo.',
            a: 'Mira al cielo y recuerda Su promesa.',
            r: 'Mt 24:27',
        },
        {
            t: 'Talentos',
            h: 'Kishronot (כִּשְׁרוֹנוֹת)',
            c: 'Parábola de los talentos',
            f: 'Responsabilidad. Usar lo dado para el Reino.',
            q: 'Bien, buen siervo y fiel; sobre poco has sido fiel.',
            a: 'Haz tu trabajo con excelencia, aunque nadie te vea.',
            r: 'Mt 25:21',
        },
        {
            t: 'El Menor',
            ...
            f: 'El rostro de Dios se esconde en el rostro del necesitado.',
            q: 'En cuanto lo hicisteis a uno de estos mis hermanos más pequeños, a mí lo hicisteis.',
            a: 'Ayuda al más vulnerable que encuentres.',
            r: 'Mt 25:40',
        },
        {
            t: 'La Copa',
            h: 'Kos (כּוֹס)',
            c: 'Última Cena',
            f: 'Pacto de sangre. Participar de su vida y de su entrega.',
            q: 'Bebed de ella todos; porque esto es mi sangre.',
            a: 'Recuerda el sacrificio de Yeshua antes de comer.',
            r: 'Mt 26:27',
        },
        {
            t: 'Discipulado',
            h: 'Talmidim (תַּלְמִידִים)',
            c: 'Gran Comisión',
            f: 'Hacer aprendices que imiten al Maestro, no solo creyentes.',
            q: 'Id, y haced discípulos a todas las naciones.',
            a: 'Enseña un principio bíblico a alguien hoy.',
            r: 'Mt 28:19',
        },
        {
            t: 'Autoridad',
            h: 'Samchut (סַמְכוּת)',
            c: 'Gran Comisión',
            f: 'Poder delegado. Actuar en Nombre del Rey.',
            q: 'Toda potestad me es dada en el cielo y en la tierra.',
            a: 'Camina con la seguridad de un hijo del Rey.',
            r: 'Mt 28:18',
        },
        {
            t: 'Sábado',
            h: 'Shabat (שַׁבָּת)',
            c: 'Espigas en Shabat',
            f: 'Cesar. El día es para el hombre, para su restauración y libertad.',
            q: 'El día de reposo fue hecho por causa del hombre.',
            a: 'Prepárate para deleitarte en el Shabat.',
            r: 'Mr 2:27',
        },
        {
            t: 'Dar',
            h: 'Natan (נָתַן)',
            c: 'El sermón del llano',
            f: 'Dar es un ciclo. Lo que das, regresa multiplicado.',
            q: 'Dad, y se os dará; medida buena... rebosando.',
            a: 'Sé generoso hoy con tu tiempo o dinero.',
            r: 'Lc 6:38',
        },
        {
            t: 'Negación',
            h: 'Mesirut Nefesh (מְסִירוּת נֶפֶשׁ)',
            c: 'Seguimiento',
            f: 'Entrega del alma. Poner la voluntad de Dios sobre la propia.',
            q: 'Si alguno quiere venir en pos de mí, niéguese a sí mismo.',
            a: "Di 'no' a un deseo egoísta hoy.",
            r: 'Lc 9:23',
        },
        {
            t: 'Arado',
            h: 'Charishah (חֲרִישָׁה)',
            c: 'Discipulado radical',
            f: 'Enfoque. No se puede hacer surcos rectos mirando atrás.',
            q: 'Ninguno que poniendo su mano en el arado mira hacia atrás, es apto.',
            a: 'No añores el pasado; enfócate en lo que viene.',
            r: 'Lc 9:62',
        },
        {
            t: 'Prójimo II',
            h: 'Rea (רֵעַ)',
            c: 'Buen Samaritano',
            f: 'La misericordia define al prójimo, no la raza.',
            q: '¿Quién de estos tres te parece que fue el prójimo?',
            a: 'Sé un buen samaritano con quien no se lo espera.',
            r: 'Lc 10:36',
        },
        {
            t: 'Luz Interior',
            h: 'Or (אוֹר)',
            c: 'Lámpara del cuerpo',
            f: 'La conciencia debe estar iluminada por la verdad, no oscurecida.',
            q: 'Mira pues, no suceda que la luz que en ti hay, sea tinieblas.',
            a: 'Examina tus intenciones más profundas.',
            r: 'Lc 11:35',
        },
        {
            t: 'Vida',
            h: 'Chayim (חַיִּים)',
            c: 'El rico insensato',
            f: 'La vida verdadera no está en las cosas, sino en la conexión con Dios.',
            q: 'La vida del hombre no consiste en la abundancia de los bienes que posee.',
            a: 'Valora una relación más que una posesión hoy.',
            r: 'Lc 12:15',
        },
        {
            t: 'Banquete',
            h: 'Seudáh (סְעוּדָה)',
            c: 'Los invitados',
            f: 'El Reino es un banquete de gracia para los indignos.',
            q: 'Cuando hagas banquete, llama a los pobres.',
            a: 'Comparte tu comida con alguien humilde.',
            r: 'Lc 14:13',
        },
        {
            t: 'Fidelidad',
            h: "Ne'eman (נֶאֱמָן)",
            c: 'Mayordomo infiel',
            f: 'Integridad en lo pequeño. Dios prueba en lo invisible.',
            q: 'El que es fiel en lo muy poco, también en lo más es fiel.',
            a: 'Cuida los detalles pequeños hoy.',
            r: 'Lc 16:10',
        },
        {
            t: 'Gratitud',
            h: 'Todah (תּוֹדָה)',
            c: 'Los diez leprosos',
            f: 'Reconocer el bien recibido completa el milagro.',
            q: '¿No eran diez los que fueron limpiados? Y los nueve, ¿dónde están?',
            a: 'Agradece a quien te ha servido hoy.',
            r: 'Lc 17:17',
        },
        {
            t: 'Oración',
            h: 'Tefilah (תְּפִלָּה)',
            c: 'Juez injusto',
            f: "Conexión constante. No desmayar es tener 'Chutzpah' (audacia) santa.",
