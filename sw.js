// sw-workbox.js - Workbox Service Worker para Qumran Watch v13.1.74
...
console.log('[SW] Workbox SW v13.1.74 iniciando...');

precacheAndRoute(
    [
        { revision: '830bb116a513550c5858d60ded660753', url: 'privacy.html' },
        { revision: '46353993195feeb7aea4bcb5f6792c55', url: 'manifest.json' },
        ...
        { revision: 'd020b9576ca3cd7d0cbe2bc334d46c13', url: 'src/js/index.js' },
...
console.log('[SW] Workbox SW v13.1.74 listo');
