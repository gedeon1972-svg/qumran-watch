...
const QumranApp = {
    ...
    renderCalendar: () => {
        ...
        setTimeout(() => {
            // CORREGIDO: Inicio de búsqueda anticipado (5 de Marzo) para capturar años con mucha deriva
            let test = new Date(y, 2, 5); 
            let html = "";
            // Aumentamos el rango de búsqueda a 380 días para cubrir todo
            for(let i=0; i<380; i++) {
